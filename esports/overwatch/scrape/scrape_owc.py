...
data_directory_pattern = r'D:\Data\speech\esports\overwatch\{}\contenders'
...
channel_id = 'UCWPW0pjx6gncOEnTW8kYzrg'
...
def download_audios():
    ...
    while True:
        ...
        for item in data['items']:
            ...
            if 'vs' not in item['snippet']['title'].lower():
                continue
            ...
            if not os.path.exists(tg_path):
                if not os.path.exists(vtt_path):
                    print(new_id)
                    subprocess.call(['youtube-dl', '--list-subs',
                                     url, ], cwd=raw_data_directory)
