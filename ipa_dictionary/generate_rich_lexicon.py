...
japanese_names_path = root_dir.joinpath('rich_lexicons', 'japanese_names.jsonl')
...
morphology_training_path = root_dir.joinpath('rich_lexicons', 'morphology_training.txt')
